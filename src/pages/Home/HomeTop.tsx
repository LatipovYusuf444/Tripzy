...
export default function HomeTop() {
    return (
        <div className='pt-40'>
            <h1 className='text-center text-white fonts text-xl leading-12 pb-10'>
                <b className='text-white text-7xl'>Dunyo bo‘ylab  <b className='text-blue-300'>premium</b> sayohat</b> <br />
                Eng yaxshi reyslar, ishonchli aviakompaniyalar va qulay bron qilish tajribasi.</h1>
            <div
                className=" mt-30
            ...
            >
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 sm:gap-6">
                    <div className="flex items-center gap-2 sm:gap-3 bg-[#0A1220]/70 rounded-xl px-3 py-3">
                        <PlaneTakeoff color="#32a3dbd8" className="text-[#FF7A00]" />
                        <input
                            type="text"
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 bg-[#0A1220]/70 rounded-xl px-3 py-3">
                        <PlaneLanding color="#32a3dbd8"  className="text-[#FF7A00]" />
                        <input
                            type="text"
                            placeholder="Qayerga"
                            className="bg-transparent outline-none text-white placeholder:text-[#9CA3AF] w-full text-sm sm:text-base"
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 bg-[#0A1220]/70 rounded-xl px-3 py-3">
                        <CalendarDays color="#32a3dbd8"  className="text-[#FF7A00]" />
                        <input
                            type="date"
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 bg-[#0A1220]/70 rounded-xl px-3 py-3">
                        <Users color="#32a3dbd8"  className="text-[#FF7A00]" />
                        <select className="bg-transparent outline-none text-white w-full text-sm sm:text-base">
                            <option className="bg-[#0A1220]">1 Passenger</option>
                            <option className="bg-[#0A1220]">2 Passengers</option>
                            <option className="bg-[#0A1220]">3 Passengers</option>
                        </select>
                    </div>
                    <button
                        className="
